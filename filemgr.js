...
const database = 'mongodb+srv://yoong:yoong724@foodsearch.b8ciq.gcp.mongodb.net/<dbname>?retryWrites=true&w=majority'; //in cloud
const client = new MongoClient(database, { useNewUrlParser: true });

const appname = 'foodsearch';
const collectionname = 'restaurant list';
