...
const PLACES_API_KEY = 'AIzaSyCNqHvtPfkk3z7e0anOvfLf6-5qmT9b2KM';
var filteredResults;

hbs.registerHelper('list', (items, options) => {
  items = filteredResults;
  var out =
    "<thead class='thead-light'><tr><th>Name</th><th>Address</th><th>Photo</th></tr></thead>";
...
server.post('/getplaces', (req, res) => {
  ...
  const locationReq = `https://maps.googleapis.com/maps/api/geocode/json?address=${addr}&key=AIzaSyCNqHvtPfkk3z7e0anOvfLf6-5qmT9b2KM`;
...
server.get('/searchhistory', (req, res) => {
  filemgr
    .getAllData()
    .then(result => {
